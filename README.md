...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.2.6-0ea5e9?style=flat-square" alt="Version">
...
```bash
curl -fsSL https://raw.githubusercontent.com/ifelse-codes/antra/main/install.sh | bash
```
